...
\begin{abstract}
%\boldmath
A review of papers on systems for rehabilitation of stroke victims was carried out, 
focusing on systems for the rehabilitation of the upper limbs. Sensors that could 
be useful for this purpose, robotic systems already in use for this purpose and 
visual sensors that can be used for motion capture are all reviewed.
Rehabilitation systems can be divided into two groups; large scale robotic systems 
and small scale sensing systems. The additional bulk of the robotic systems comes from 
the need to be actuated and to be constructed of materials sturdy enough to 
withstand the forces exerted by the actuators.
Exoskeletal robotic systems were identified as the better choice for the large scale 
systems as they provide the most information on the patient.
Visual sensors were identified as having a lot of potential for cheap, small scale 
systems that could be used by the patient at home.
Having the rehabilitation system linked to a game that encourages the patient to 
perform actions from their rehabilitation is found to be valuable in terms of 
maintaining the patient's enthusiasm.
An absence of any exoskeletal systems for both the arm and hand combined was 
discovered highlighting this as an area that might warrant investigation.
\end{abstract}
...
\begin{IEEEkeywords}
Stroke rehabilitation, robot, sensors, body position, upper limbs, exoskeleton. % to be added to...
\end{IEEEkeywords}
...
\IEEEPARstart{R}{obotic} systems are systems which are able to not only measure the position 
...
\IEEEPARstart{C}{ameras} and computing power are getting cheaper all the time and are therefore 
...
\bibitem{VRHandFinger} O. a. Daud, R. Oboe, M. Agostini, and A. Turolla, “Performance evaluation of a VR-based hand and finger rehabilitation program,” 2011 IEEE International Symposium on Industrial Electronics, pp. 934-939, Jun. 2011.
