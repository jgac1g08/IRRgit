...
\begin{IEEEkeywords}
Stroke, robot, sensors. % to be added to...
\end{IEEEkeywords}
...
right-hemispherical victims, becoming ponderous and unsure \cite{NSA}.
...
controls essential functions such as your heart, breathing and swallowing \cite{NSA}.
...
their independence. The management of stroke patients is broken down into three areas: acute care, rehabilitation care and community care \cite{Physio}.
...
can be evaluated, a popular one is the fugl-meyer test which score the patient 
...
the patient, allowing them to monitor there own progress. Linking the system to a game or simulated 
...
driven over needs to be the same as that of the human arm and there should be systems in 
...
also be comfortable to use for extended periods. [REF]

It has also been shown to be helpful for the system to incorporate some form of interactive 
virtual environment, such as a game, in order to increase their motivation and maintain 
...
Mapping position in space: accelerometers, strain gauge, ...
...
values via wireless modules to a computer where these values are analysed [REF].

\subsection{Angle Sensors} 
\subsubsection{The sensors}
Mapping angle (e.g. at joints): potentiometers, magnetometers, ...
\subsubsection{How they're used}
What they're used for and example of systems using them this way ...

\subsection{Force Sensors}
\subsubsection{The sensors}
Mapping force (gripping/pushing): QTCs, force resistors, ...
\subsubsection{How they're used}
What they're used for and example of systems using them this way ...
...
patient's wrist and thus it's position in 3d space can be tracked and controlled (via actuation) 
which allows the system to monitor the performance of an action and show variations. [REF]

[examples of end-effector systems and what they can do]
...
\begin{thebibliography}{1} % will need properly formatting later
  
\bibitem{NSA} National STROKE Association. (2012, April 14). \emph{Effects of Stroke}
[Online]. Available: \url{http://www.stroke.org/site/PageServer?pagename=EFFECT}

\bibitem{TheBrain} J. Caswell. (2012, April 11). \emph{A Tour of the Brain}
[Online]. Available: \url{http://www.strokeassociation.org/STROKEORG/AboutStroke/EffectsofStroke/ATouroftheBrain/A-Tour-of-the-Brain_UCM_310943_Article.jsp}

\bibitem{Physio} physiotherapy-treatment.com (2012, April 5). \emph{stroke physical therapy}
[Online]. Available: \url{http://www.physiotherapy-treatment.com/stroke-physical-therapy.html}
...
\begin{IEEEbiographynophoto}{John Charlesworth}
Biography text here.
